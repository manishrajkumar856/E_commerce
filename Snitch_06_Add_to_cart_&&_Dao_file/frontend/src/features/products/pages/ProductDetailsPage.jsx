            ...
            <div className="px-6 md:px-12 lg:px-24 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                ...
                <div className="lg:col-span-5 flex flex-col pt-4">
                    ...
                    <div className="flex flex-col gap-4 mb-12">
                        ...
                        {!isSeller && (
                            <button onClick={addToCart} className="flex items-center justify-center gap-3 w-full py-5 border border-[var(--theme-border)] text-[var(--theme-text)] font-black tracking-widest uppercase text-sm hover:bg-[var(--theme-input-bg)] transition-all rounded-2xl">
