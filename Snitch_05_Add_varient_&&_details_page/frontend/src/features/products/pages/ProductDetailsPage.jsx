...
import { ShoppingBag, ChevronRight, Heart, Share2, ShieldCheck, Truck, RefreshCw, CloudCog } from "lucide-react";
        ...
        <div className="min-h-screen bg-[var(--theme-bg)] pb-32">
            ...
            <div className="px-6 md:px-12 lg:px-24 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                ...
                <div className="lg:col-span-7 flex flex-col-reverse md:flex-row gap-6">
                    ...
                    {/* Main Image */}
                    <div className="flex-1 aspect-[3/4] overflow-hidden bg-[var(--theme-card-bg)] rounded-2xl group border border-[var(--theme-border)]">
                        <img
                ...
                <div className="lg:col-span-5 flex flex-col pt-4">
                    ...
                    <div className="flex flex-col gap-4 mb-12">
                        <button className="flex items-center justify-center gap-3 w-full py-5 bg-primary text-white font-black tracking-widest uppercase text-sm hover:bg-primary-dark transition-all rounded-2xl shadow-xl shadow-primary/20">
